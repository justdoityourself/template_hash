...
TEST_CASE("Overflow2", "[hash::]")
{
    ...
    std::string_view d("testtesttesttesttesttesttes37623");
    V b1(d.begin(), d.begin() + 27);
    V b2(d.begin(), d.begin() + 32);

    {
        alignas(16) typename template_hash::stateful::State_16_32_1::byte_type control, context;

        template_hash::stateful::State_16_32_1::hash(gsl::span<uint8_t>(b1.data(), 27), context);
        template_hash::stateful::State_16_32_1::hash(gsl::span<uint8_t>(b2.data(), 27), control);
...
TEST_CASE("Segmented Hash Start + Continue + Finish", "[hash::]")
{
    ...
    std::array<uint16_t, 4> context,control;
    ...
    _general_hash<uint8_t>(std::string_view("testtest3"), poly,control);
...
TEST_CASE("Segmented Hash Start + Finish + Odd", "[hash::]")
{
    ...
    _general_hash<uint8_t>(std::string_view("tests"), poly,control);
    ...
    _general_hash<uint8_t>(std::string_view("testss"), poly,control);
    ...
    _general_hash<uint8_t>(std::string_view("testsss"), poly,control);
    ...
    _general_hash<uint16_t>(std::string_view("testtest"), poly,control);
    ...
    _general_hash<uint16_t>(std::string_view("testtests"), poly,control);
    ...
    _general_hash<uint16_t>(std::string_view("testtestss"), poly,control);
    ...
    _general_hash<uint16_t>(std::string_view("testtestsss"), poly,control);
...
TEST_CASE("Segmented Hash Start + Finish", "[hash::]")
{
    ...
    _general_hash<uint8_t>(std::string_view("test"), poly,control);
